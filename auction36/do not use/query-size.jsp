	...
	<body>
		...
		<%} else {
			try {
				...
				String price = request.getParameter("screen_search");
				//String option = request.getParameter("command");
				
				
				String query = "SELECT * FROM AuctionEvent a, Product p WHERE a.product_id = p.product_id and p.screen_size > " + price;				 
