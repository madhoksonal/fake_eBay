	...
	<body>
		...
		<%} else {
			try {
				...
				String keyword = request.getParameter("text_search");
				String option = request.getParameter("command");
				
				
				String query = "SELECT * FROM AuctionEvent a, Product p WHERE a.product_id = p.product_id and p." + option + " LIKE '"+ keyword +"'";				 
