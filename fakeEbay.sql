...
INSERT INTO Buys VALUES -- These are the bids
	...
	(1, 4, 8, 1400, 1315),
	(4, 4, 8, 1600, 1400);
INSERT INTO question_answer (question_id, question, answer, user_account_id,
 rep_account_id) VALUES
	('1', 'How many bids can we add?', NULL, 1, NULL),
    ('2', 'How will we recieve alerts?', 'When the bid ends', 2, 1);
